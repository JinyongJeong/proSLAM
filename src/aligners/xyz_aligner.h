...
namespace proslam
{
// ds this class specifies an aligner for camera centric point clouds (used to compute the spatial relation between
// local maps for a loop closure)
...
public:
  ...
  virtual void initialize(Closure* context_,
                          const TransformMatrix3D& current_to_reference_ = TransformMatrix3D::Identity());
