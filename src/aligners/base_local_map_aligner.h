...
public:
  ...
  virtual void initialize(Closure* context_,
                          const TransformMatrix3D& current_to_reference_ = TransformMatrix3D::Identity()) = 0;

  // ds setters/getters
public:
  inline const TransformMatrix3D& currentToReference() const
  {
    return _current_to_reference;
  }
