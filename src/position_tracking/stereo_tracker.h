...
public:
  ...
  // ds setters/getters
public:
  void setCameraRight(const Camera* camera_right_)
  {
    _camera_right = camera_right_;
  }
  void setIntensityImageRight(const cv::Mat& intensity_image_right_)
  {
    _intensity_image_right = intensity_image_right_;
  }
